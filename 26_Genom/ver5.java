...
        cS = 2*cos(j);                          
                                  
        Color colAdd = new Color(j, 100, 150, abs(cS*300));                          
        int l = lifeTime;                          
                                  
...
        fill(abs(c.pos.x+20), 255, 60, (c.col.O)-c.life); //反映したいなんとか
...
                                                  
    //add----                                              
    String outP = "D:\\09_music_create\\03_PICTURE\\99_Render\\26_Lissajous\\5\\26_Penrose-30_######.png";                                              
    saveFrame(outP);                                              
    //----                                              
                                              
}  
