...
                                                  
    //add----                                              
    String outP = "D:\\09_music_create\\03_PICTURE\\99_Render\\26_Lissajous\\7\\26_Penrose-30_######.png";                                              
    saveFrame(outP);                                              
    //----                                              
                                              
}  
...
    fill(255);
    translate((width/2), (height/2));
    ellipse(random(width/12), 0, size, size);
    pop();
  //}
...
void draw_color_glitch(PImage img, int shift_size){
  
  background(0);

  int left_color = color(155, 0, 0);
  int right_color = color(100, 255, 255);

  push();
  blendMode(ADD);

  tint(left_color);
  image(img, -shift_size-width/2, -height/2);
