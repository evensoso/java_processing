...
        float u = 2 * sin(i+y) * sin(i+y) * sin(j + x);
        float v = exp(-(sin(i+y) + cos(i+x)) * sin(j+y));
        x=u+t;
        y=v;

        cX= size *(u*N/2+W/2);
        cY= size *(y*N/2+W/2) - 500;
                   
                                     
//-------------------------------------                   
                                            
...
                                                  
    //add----                                              
    String outP = "D:\\09_music_create\\03_PICTURE\\99_Render\\23_Lissajous\\3\\23_Penrose-30_######.png";                                              
    saveFrame(outP);                                              
    //----                                              
                                              
}                                              
