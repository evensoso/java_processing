...
        float u = sin(i+y+200)+sin(i+x + 200);
        float v = cos(i+y-count)+cos(i+x);
        x=u+t;
        y=v;
...
        cS = sin(j);                          
                                  
        Color colAdd = new Color(j, i, 150, o);                          
        int l = lifeTime;                          
                                  
...
                                                  
    //add----                                              
    String outP = "D:\\09_music_create\\03_PICTURE\\99_Render\\23_Lissajous\\5\\23_Penrose-30_######.png";                                              
    saveFrame(outP);                                              
    //----                                              
                                              
}                                              
