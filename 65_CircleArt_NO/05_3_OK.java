...
void setup() {
 ...
 void draw() {
  ...
  String fileName = "64_Moon-FF_" + "c_" + count + "_######.png";
  String outP = root + "64_Moon\\" + "2\\" + fileName;
    //----
  ...
  float treeCount = 2; //int(random(2, 6));
...
void drawTree() {
  ...
  Point toPoint = new Point(pointEndX, pointEndY, widthEnd, colorEnd);
...
void spawnDot(float _x, float _y, float _size, float _length, NYColor _color) {
    ...
    for (int i = 0; i < dotCount; i++) {
        ...
        noStroke();
        fill(nowColor.h, nowColor.s, nowColor.b, nowColor.a * 200);
        //fill(255);
