...
void draw() {                          
  ...
  for(float i = 0; i < 100 * PI; i += PI / 24){                          
    ...
    Color colAdd = new Color(12, 100, 150, i-20);                          
    ...
    for (Line l : Lines) {      
      //translate(width/2, height/2);              
        fill(l.col.R, l.col.B, l.col.G, random(1000)); //-c.life/20 
        rotate(random(10));
  ...
  //フォルダは自動生成                          
  String outP = "D:\\09_music_create\\03_PICTURE\\99_Render\\08_MilkyWay\\1\\08_MilkyWay-NN_######.png";                          
  saveFrame(outP);                          
  //----                          
