...
        
        Circle cAdd = new Circle(cX, cY, 0, cS, colAdd);
        circles.add(cAdd);
        //circle(cX, cY, cO);   
    }
...
                        
    //add----                    
    String outP = "D:\\09_music_create\\03_PICTURE\\99_Render\\21_Lissajous\\7\\22_Penrose-30_######.png";                    
    saveFrame(outP);                    
    //----                    
                    
}                    
...
  Color col;
  
  Circle (float x, float y, float z, float s, Color c) {  
    xPos = x; 
    yPos = y;
    zPos = z; 
    size = s; 
