...
void setup() {
  size(1080,1080,P2D);    // P3D was in the original code, but it runs VERY slow here on openprocessing
                        // (unfortunate, since P3D looks better)
//  size(dim,dim,P3D);
  String picP = "D:\\TaskScheduled\\02_processing\\000\\000_Syakyu\\02_Earth_OK\\Asset\\02.gif";
  print(picP);
  takecolor(picP);
  background(255);
  frameRate(30);
...
void draw() {
  ...
  String root = "D:\\09_music_create\\03_PICTURE\\99_Render\\000_Shakyu\\";
  String folName = "02-NNN";
  String pPath = root + folName + "\\ver2\\2\\" + folName + "-######.png";
  print(count + ";");
