...
void drawTree() {
  ...
  JSONObject fromPoint;
  fromPoint = new JSONObject();

  fromPoint.setFloat("x", pointStartX);
  fromPoint.setFloat("y", pointStartY);
  fromPoint.setFloat("width", widthFrom);
  fromPoint.setFloat("color", colorFrom);
  
  JSONObject toPoint;
  toPoint = new JSONObject();

  toPoint.setFloat("x", pointStartX);
  toPoint.setFloat("y", pointStartY);
  toPoint.setFloat("width", widthEnd);
  toPoint.setFloat("color", colorEnd);
  ...
  */
  ...
  // layer 1: tree dark back
  {
    ...
    fromPoint.setFloat("color", fromPP);
    //fromPoint.color.slightRandomize(30, 20, 20);

    toPoint.setFloat("color", toPP);
  ...
  for (int i = 0; i < 6; i++) {
    ...
    fromPoint.setFloat("color", colorA);
    toPoint.setFloat("color", colorB);
...
float skipChance = 0.0;
 ...
 void drawStick(JSONObject _fromPoint, JSONObject _toPoint) {

    float sliceCount = dist(_fromPoint.getFloat("x"), _fromPoint.getFloat("y"), _toPoint.getFloat("x"), _toPoint.getFloat("y")) * sketchDensity;
    ...
    for (int i = 0; i < sliceCount; i++) {
        ...
        float nowX = lerp(_fromPoint.getFloat("x"), _toPoint.getFloat("x"), t);
        float nowY = lerp(_fromPoint.getFloat("y"), _toPoint.getFloat("y"), t);

        float nowWidth = lerp(_fromPoint.getFloat("width"), _toPoint.getFloat("width"), t);
        float nowColor = NYLerpColor(_fromPoint.getFloat("color"), _toPoint.getFloat("color"), t);
...
Boolean drawStickFungi(JSONObject _fromPoint, JSONObject _toPoint, float _xRatio, float _yRatio) {

    float nowX = lerp(_fromPoint.getFloat("x"), _toPoint.getFloat("x"), _yRatio);
    float nowY = lerp(_fromPoint.getFloat("y"), _toPoint.getFloat("y"), _yRatio);
    float nowWidth = lerp(_fromPoint.getFloat("width"), _toPoint.getFloat("width"), _yRatio);
    ...
    float stickAngle = getAngle(_fromPoint.getFloat("x"), _fromPoint.getFloat("y"), _toPoint.getFloat("x"), _toPoint.getFloat("y"));
...
void spawnFungi(float _x, float _y, float _length, float _thickness, float _headSize, float _startAngle) {
    ...
    for (int i = 0; i < lineCount; i++) {
        ...
        float dotSize = map(t, 0.0, 0.15, 0, 1, true); //★
